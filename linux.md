...
###### multipath with loopback locally
...
o- / ......................................................................................................................... [...]
  ...
  | | o- lun0 ........................................................................... [/dev/loop0 (1.0GiB) write-thru activated]
  ...
  | o- naa.50014056f09d9cd9 ................................................................................. [naa.50014058ecf2702a]
  | | o- luns ............................................................................................................ [LUNs: 1]
  | |   o- lun0 ....................................................................... [block/lun0 (/dev/loop0) (default_tg_pt_gp)]
  | o- naa.5001405a31b43fc6 ................................................................................. [naa.500140515b06cd0a]
  |   o- luns ............................................................................................................ [LUNs: 1]
  |     o- lun0 ....................................................................... [block/lun0 (/dev/loop0) (default_tg_pt_gp)]
  o- vhost ............................................................................................................ [Targets: 0]
  o- xen-pvscsi ....................................................................................................... [Targets: 0]

$ targetcli /backstores/block/lun0 info
dev: /dev/loop0
name: lun0
plugin: block
readonly: False
write_back: False
wwn: 7f4de894-966a-4990-80b9-761ad82334c0

$ rescan-scsi-bus.sh &>/dev/null

$ lsscsi |grep LIO
[8:0:1:0]    disk    LIO-ORG  lun0             4.0   /dev/sde 
[9:0:1:0]    disk    LIO-ORG  lun0             4.0   /dev/sdf 

$ for i in e f; do /usr/lib/udev/scsi_id -g /dev/sd${i} ; done
360014057f4de894966a499080b9761ad
360014057f4de894966a499080b9761ad
```
